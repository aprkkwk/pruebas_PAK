...
WebUI.click(findTestObject('Refactorizado/Page_Todas nuestras tiendas - Parque Arauco/div_paris'))

WebUI.click(findTestObject('Page_Tienda Parque Arauco-/button_Ver mapa'))

WebUI.click(findTestObject('Page_Tienda Parque Arauco-/button_'))
